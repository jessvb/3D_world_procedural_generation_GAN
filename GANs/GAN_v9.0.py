# v9.0 tries to fix the issue with the discriminator loss blowing up by using tf.maximum for Dx
# ^^ this doesn't fix it :'(
...
# (numImgs, IMAGE_SIZE, IMAGE_SIZE, 1): (###, 256, 256, 1)
...
# ^^ since we're getting nan as our discriminator loss as some points, let's take the maximum of
# Dx and a really small number to stabalize the numbers:
Dx = tf.maximum(discriminator(x_placeholder), 1e-9)
