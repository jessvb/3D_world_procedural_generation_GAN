## v4.2 uses two different alphas and image resize upscaling and 256x256px images

## TODO: things to try: - changing from normal to uniform distribution
##                      - changing from between -1 and 1 to between 1 and 2 so things don't zero out??
##                      - chaging the number of conv layers in the generator (less layers, but still output 256x256)
##                      - go back to the patterened upscaling and try 1-to-1 deconv layer at the end (apparently this helps!)
