# v7.0 has fewer convolutional layers in the generator (3 instead of 4)
...
# - changing the number of conv layers in the generator (less layers, but still output 256x256)
