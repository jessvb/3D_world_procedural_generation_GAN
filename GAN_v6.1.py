# v6 uses transpose upscaling and a FILTER_SIZExFILTER_SIZE filter and different d/g alphas
...
D_ALPHA = 3e-5  # the discriminator learning rate todo
...
def generator(z, batch_size, z_dim, reuse=False):
    with tf.variable_scope('generator') as scope:
        ...
        # Second DeConv Layer
        # was [batch_size, s4 - 1, s4 - 1, g_dim*2]
        ...
        # Third DeConv Layer
        # this was [batch_size, s2 - 2, s2 - 2, g_dim*1]
...
while i < iterations*batch_size:
    ...
    z_batch = np.random.normal(-1, 1, size=[batch_size, z_dimensions]) #uniform?? todo
